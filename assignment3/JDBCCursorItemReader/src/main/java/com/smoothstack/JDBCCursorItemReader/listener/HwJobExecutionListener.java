package com.smoothstack.JDBCCursorItemReader.listener;
...
public class HwJobExecutionListener implements JobExecutionListener {
    ...
    public void beforeJob(JobExecution jobExecution){
        ...
        jobExecution.getExecutionContext().put("my name", "Marcus");
        System.out.println("before starting the Job - after set" + jobExecution.getExecutionContext().toString());
    }

    @Override
    public void afterJob(JobExecution jobExecution){
        System.out.println("after the starting the Job - Job Execution Context " + jobExecution.getExecutionContext().toString());
    }
